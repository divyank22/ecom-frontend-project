<template>
    <header>
      <nav class="flex w-auto bg-blue-600 mx-1 justify-between shadow-2xl rounded-md">
        ...
        <ul class="flex list-none">
          ...
          <div id="search-toggle" ref="searchToggle" class="search-icon cursor-pointer pl-6 mx-1 md:mx-4 my-auto" aria-label="Toggle search">
      ...
      <div ref="searchContent" class="relative w-full hidden bg-white shadow-xl" id="search-content">
        <div class="container mx-auto py-4 text-black">
          <input ref="searchField" id="searchfield"v-model="searchTerm" type="search" placeholder="Search..." autofocus class="w-full text-grey-800 transition focus:outline-none focus:border-transparent p-2 appearance-none leading-normal text-xl lg:text-2xl">
        </div>
  ...
  onMounted(() => {
    searchToggle.value.addEventListener('click', () => {
